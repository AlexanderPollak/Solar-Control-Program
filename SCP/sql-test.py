...
def main():
    ...
    try:
        ...
        logger.error(
            "telnet connection for secondary weatherstation could not be established, default values will be send")
        conn_telnet2 = False
    ...
    try:
        ...
        logger.error(
            "telnet connection for primary weatherstation could not be established, default values will be send")
        conn_telnet1 = False
